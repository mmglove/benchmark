...
export model_name=SLANet_bs64_fp16_DP
export job_name=PaddleX_table_structure_recognition_SLANet_bs64_fp16_DP_N1C1
...
train_cmd="python main.py -c paddlex/configs/modules/table_structure_recognition/SLANet.yaml -o Global.mode=train -o Global.dataset_dir=dataset/table_rec_dataset_train_benchmark -o Train.epochs_iters=1 -o Train.log_interval=1 -o Train.eval_interval=100 -o Train.save_interval=400 -o Global.model=SLANet -o Train.batch_size=64 -o Benchmark.amp=O2 -o Benchmark.num_workers=1 -o Benchmark.shuffle=False -o Benchmark.shared_memory=True -o Benchmark.print_mem_info=True -o Benchmark.cal_metrics=False -o Benchmark.seed=1024 -o Benchmark.do_eval=False -o Benchmark.disable_deamon=True -o Benchmark.env.FLAGS_eager_delete_tensor_gb=0.0 -o Benchmark.env.FLAGS_fraction_of_gpu_memory_to_use=0.98 -o Benchmark.env.FLAGS_conv_workspace_size_limit=4096 -o Global.device=gpu:${CUDA_VISIBLE_DEVICES} -o Global.output=output/$job_name -o Train.uniform_output_enabled=False"
